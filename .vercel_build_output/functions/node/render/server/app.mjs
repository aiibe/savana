...
const client_component_lookup = {".svelte/build/runtime/internal/start.js": "start-ed737c8e.js", "src/routes/index.svelte": "pages/index.svelte-6e32a407.js"};
const manifest = {
  assets: [{file: "css/global.css", size: 146, type: "text/css"}, {file: "favicon.ico", size: 1150, type: "image/vnd.microsoft.icon"}, {file: "robots.txt", size: 67, type: "text/plain"}, {file: "savana.png", size: 3389, type: "image/png"}, {file: "savana.svg", size: 4498, type: "image/svg+xml"}],
  ...
  routes: [
    {
      ...
      css: ["assets/start-fd8a8280.css"],
      js: ["start-ed737c8e.js", "chunks/index-d81b958d.js", "pages/index.svelte-6e32a407.js"]
    }
  ]
};
...
const Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Savana</title>`, ""}`, ""}

<section class="${"section has-background-white-bis"}"><div class="${"container"}"><div class="${"columns is-centered mt-5"}"><div class="${"column is-half"}"><div class="${"box content"}"><p>This is a static post</p></div></div></div></div></section>`;
});
...
var global = `@import "https://cdn.jsdelivr.net/npm/bulma@0.9.2/css/bulma.min.css";
...
const Signup = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let email = "";
  let password = "";
  return `<div class="${"modal is-active"}"><div class="${"modal-background"}"></div>
	<div class="${"modal-content"}"><div class="${"box content"}"><h3>Create your account</h3>
			<p>Publish and share your content</p>
			<form><div class="${"field"}"><label class="${"label"}">Email</label>
					<div class="${"control"}"><input class="${"input"}" type="${"email"}"${add_attribute("value", email, 1)}></div></div>
				<div class="${"field"}"><label class="${"label"}">Password</label>
					<div class="${"control"}"><input class="${"input"}" type="${"password"}"${add_attribute("value", password, 1)}></div></div>
				<div class="${"field is-grouped is-grouped-right"}"><p class="${"control"}"><a class="${"button is-success"}">Submit</a></p>
					<p class="${"control"}"><a class="${"button is-light"}">Cancel</a></p></div></form></div></div></div>`;
});
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="${"modal is-active"}"><div class="${"modal-background"}"></div>
	<div class="${"modal-content"}"><div class="${"box content"}"><h1>Login</h1></div></div></div>`;
});
const Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $modal, $$unsubscribe_modal;
  $$unsubscribe_modal = subscribe(modal, (value) => $modal = value);
  $$unsubscribe_modal();
  return `<nav class="${"navbar has-shadow"}"><div class="${"container"}"><div class="${"navbar-brand"}"><a href="${"/"}" class="${"navbar-item"}"><img src="${"/static/savana.png"}" alt="${"savana logo"}"></a></div>
		<div class="${"navbar-menu"}"><div class="${"navbar-end"}"><div class="${"navbar-item"}"><button class="${"button"}">Login</button></div>
				<div class="${"navbar-item"}"><button class="${"button is-success"}">Signup</button></div></div></div></div></nav>

${$modal === "signup" ? `${validate_component(Signup, "Signup").$$render($$result, {}, {}, {})}` : `${$modal === "login" ? `${validate_component(Login, "Login").$$render($$result, {}, {}, {})}` : ``}`}`;
});
